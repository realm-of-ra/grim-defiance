...
mod tests {
    ...
    use grim_defiance::systems::actions::{actions, IActionsDispatcher, IActionsDispatcherTrait};
    use grim_defiance::models::{Position, m_Position, Moves, m_Moves, Direction};

    fn namespace_def() -> NamespaceDef {
        let ndef = NamespaceDef {
            namespace: "grim_defiance", resources: [
                ...
                TestResource::Contract(
                    ContractDefTrait::new(actions::TEST_CLASS_HASH, "actions")
                        .with_writer_of([dojo::utils::bytearray_hash(@"grim_defiance")].span())
                )
            ].span()
        };
